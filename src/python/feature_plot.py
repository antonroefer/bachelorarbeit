...
plt.imshow(data, aspect="auto", cmap="Grays")
plt.title("Original Radargram")
plt.colorbar(label="Amplitude")
plt.xlabel("Trace")
plt.ylabel("Sample")
plt.savefig(fname="feature_plots/0_original_radargram.png", dpi=300)

# List of all attributes to calculate and plot, now with vmin and vmax
attributes = [
    # Attribute name, title, vmin, vmax
    # ("instantaneous_amplitude", "Instantaneous Amplitude (Envelope)", 300, 0),
    ...
    # ("instantaneous_q", "Instantaneous Q", 50, 0),
